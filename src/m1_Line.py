...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        start_sum=Point(self.start.x+other_line.start.x,self.start.y+other_line.start.y)
        end_sum=Point(self.end.x+other_line.end.x,self.end.y+other_line.end.y)
        return Line(start_sum,end_sum)
    ...
    def line_minus(self, other_line):
        ...
        start_diff = Point(self.start.x - other_line.start.x, self.start.y - other_line.start.y)
        end_diff = Point(self.end.x - other_line.end.x, self.end.y - other_line.end.y)
        return Line(start_diff, end_diff)
